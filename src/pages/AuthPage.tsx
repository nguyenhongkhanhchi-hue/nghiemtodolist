      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div className="size-16 mx-auto mb-4 rounded-2xl bg-[var(--accent-dim)] flex items-center justify-center border border-[var(--border-accent)]">
            <span className="text-3xl font-bold text-[var(--accent-primary)]">T</span>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[var(--bg-elevated)] rounded-xl pl-11 pr-12 py-3.5 text-sm text-[var(--text-primary)] placeholder-[var(--text-muted)] outline-none border border-[var(--border-subtle)] focus:border-[var(--accent-primary)] min-h-[48px]"
            ...
            <div className="text-center pt-2">
              <button
                onClick={() => { setStep('register_email'); setError(''); setPassword(''); }}
          ...
          <div className="space-y-3">
            ...
            <div className="text-center pt-2">
              <button
                ...
                className="text-sm text-[var(--text-muted)] active:opacity-70"
              >
        ...
        {step === 'register_otp' && (
          <div className="space-y-3">
            ...
            <button
              onClick={handleSendOtp}
              disabled={loading}
              className="w-full py-2 text-xs text-[var(--text-muted)] active:opacity-70"
            >
              Gửi lại mã
            </button>
          </div>
        ...
        <div className="mt-6 text-center">
          <button
            onClick={() => setUser({ id: 'guest', email: 'guest@local', username: 'Khách' })}
